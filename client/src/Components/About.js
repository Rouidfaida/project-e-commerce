  ...
  return <div>
      <Navbare/>
       <div className="about">
        ...
        <p>
        Destinée aux universitaires et aux professionnels, MDL est un acteur potentiel sur le marché du livre en Tunisie. Elle présente son service de conseil, 
        d’assistance et de soutien à sa clientèle son principal capital.
        
        </p>
        <h1 className="title">Notre édition
</h1>
        <p>
